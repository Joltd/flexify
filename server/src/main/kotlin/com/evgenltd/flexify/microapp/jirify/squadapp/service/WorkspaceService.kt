...
import com.evgenltd.flexify.microapp.jirify.common.service.WorkspaceService
import com.evgenltd.flexify.microapp.jirify.squadapp.entity.repositoryByType
import com.evgenltd.flexify.microapp.jirify.squadapp.entity.toSelect
    ...
    fun workspace(user: User): WorkspaceResponse = workspaceRepository
        ...
        .let {
            WorkspaceResponse(
                id = it.id!!,
                name = it.name,
                backendRepository = it.repositoryByType(DevelopmentArea.BACKEND).toSelect(),
                frontendRepository = it.repositoryByType(DevelopmentArea.FRONTEND).toSelect(),
            )
        }
